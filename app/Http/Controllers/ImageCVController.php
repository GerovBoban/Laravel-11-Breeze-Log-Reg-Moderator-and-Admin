...
class ImageCVController extends Controller
{
    ...
    */
    Public Function index () 
    {
        ...
        return view('txtwelcome.index', ['txtwelcomes' => $txtwelcomes]);
    ...
    public function store(Request $request)
    {
        ...
        return to_route('txtwelcome.index')->with('status', 'File Has been uploaded successfully in Laravel');
  ...
  /**
    ...
    public function edit(Txtwelcome $txtwelcome)
    {
        ...
        return view('txtwelcome.edit', ['txtwelcome' => $txtwelcome]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $txtwelcome = $request->validate([
         ...
         If ($txtwelcome->update()){
            return to_route('txtwelcome.index', $txtwelcome)->with('message', 'Message was updated');
        }
        else{
    ...
    public function destroy(Txtwelcome $txtwelcome)
    {
        ...
        return to_route('txtwelcome.index')->with('message', 'Note was deleted');
    }
