    ...
    <div class="note-container single-note">
        ...
        <div class="note-container A_single-note">
            <div class="button button5">
                <form action="{{ route('txtwelcome.store') }}" method="POST" class="note" enctype="multipart/form-data">
                    ...
                    <div class="button button5A">
                        ...
                        {{-- placeholder="Image welcome page - Slika naslovna" multiple /> --}}
                        {{-- <input type="file" id="avatar" name="img_lnk" accept="image/png, image/jpeg" /> --}}
                    </div>
                    {{-- <div class="button button5A">
                         <label for="exampleInputEmail1" class="button button5B">LINK LINK</label>
                         <textarea name="img_lnk" rows="2" class="button button5C" placeholder="Link"></textarea>
                         </div> --}}
                    <div class="button button5A">
