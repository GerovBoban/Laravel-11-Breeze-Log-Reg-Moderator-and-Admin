...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
        ...
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <div
                    ...
                    <div class="row">
                        <div class="col-3"> <img src="{{ URL::asset('/policeman/Slika_Gerov_Boban.jpg') }}"
                                alt="Gerov Boban - slika" width="255">
                        </div>
                        <div class="col-9">
                            @foreach ($txtwelcomes->where('img_name', 'Gerov Boban') as $txtwelcome)
                                <ul></ul>
                                <div class="col-9">
                                    {{-- *** Da vrati iy MySql nlbr - ENTER *** --}}
                ...
                @foreach ($Portfolios->where('Yes_No', 'DA') as $Portfolio)
                    <div
                        ...
                        <div class="row">
                            ...
                            <div class="col-11" style="color:rgb(191, 7, 7)"> {{ $Portfolio->language_1 }}
                            </div>
                            <div class="col-12">
                    ...
                    <div
                        ...
                        <div class="row">
                            ...
                            <div class="col-11" style="color:rgb(7, 164, 68)"> {{ $Portfolio->language_3 }}
                            </div>
                            <div class="col-12">
    ...
    <p class="text-center ...">
        <a class="btn btn-outline-dark" href="#" role="button">Up</a>
        {{-- <a class="btn btn-primary" href="#" role="button">Link</a> --}}
        {{-- <button type="button" class="btn btn-outline-dark">Gore</button> --}}
